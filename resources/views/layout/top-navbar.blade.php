    ...
    <div class="topbar container-fluid">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            <li class="dropdown d-lg-none">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="ui-buttons.html#" role="button" aria-haspopup="false" aria-expanded="false">
            ...
            <li class="dropdown d-none d-sm-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                    ...
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="ui-buttons.html#">
            ...
            <li class="d-none d-md-inline-block">
                <a class="nav-link" href="ui-buttons.html" data-toggle="fullscreen">
                    <i class="ri-fullscreen-line fs-22"></i>
                </a>
            </li>

            <li class="dropdown me-md-2">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="ui-buttons.html#" role="button" aria-haspopup="false" aria-expanded="false">
